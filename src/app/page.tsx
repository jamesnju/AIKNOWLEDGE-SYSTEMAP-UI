...
//               </div>
//               <span className="text-xl font-bold text-primary">AgriPoa</span>
//             </Link>
            
//             <div className="hidden md:flex items-center gap-6">
//               <Link href="/" className="text-gray-700 hover:text-primary transition-colors flex items-center gap-1">
//                 <FiHome size={16} /> Home
//               </Link>
//               <Link href="/resources" className="text-gray-700 hover:text-primary transition-colors flex items-center gap-1">
//                 <FiGrid size={16} /> Resources
//               </Link>
//               <Link href="/analytics" className="text-gray-700 hover:text-primary transition-colors flex items-center gap-1">
//                 <FiBarChart2 size={16} /> Analytics
//               </Link>
//               <Link href="/about" className="text-gray-700 hover:text-primary transition-colors flex items-center gap-1">
//                 <FiInfo size={16} /> About
//               </Link>
//               <Link href="/contact" className="text-gray-700 hover:text-primary transition-colors flex items-center gap-1">
//                 <FiMail size={16} /> Contact
//               </Link>
//               <Link href="/help" className="text-gray-700 hover:text-primary transition-colors flex items-center gap-1">
...
//       {/* Content Section with Filters - Blended Cards */}
...
//           {/* Content Grid - Enhanced Cards that blend with background */}
//           {loading ? (
...
//                   <FiZap className="text-white" size={20} />
//                 </div>
//                 <span className="text-xl font-bold">AgriPoa</span>
//               </div>
...
//               <p className="text-gray-400 text-sm mb-2">Subscribe for farming tips and updates</p>
//               <div className="flex gap-2">
//                 <input type="email" placeholder="Your email" className="flex-1 px-3 py-2 rounded-lg text-gray-900 text-sm" />
//                 <button className="bg-primary px-4 py-2 rounded-lg text-sm hover:bg-primary-dark transition-colors">Subscribe</button>
//               </div>
//             </div>
//           </div>
//           <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
//             <p>&copy; 2024 AgriPoa. All rights reserved.</p>
//           </div>
//         </div>
//       </footer>
