...
//   const [chatMessages, setChatMessages] = useState<Array<{text: string, isUser: boolean}>>([
//     { text: "Hello! I'm your AI farming assistant. How can I help you today? 🌱", isUser: false }
//   ]);
//   const [inputMessage, setInputMessage] = useState('');
//   const [isTyping, setIsTyping] = useState(false);
...
//   useEffect(() => {
//     fetchContents();
//     // Auto-show welcome toast on page load
//     setTimeout(() => {
...
//     const responses: { [key: string]: string } = {
//       // Crop diseases
//       'maize disease': "Common maize diseases include: 1️⃣ **Maize Lethal Necrosis** - causes rapid wilting. 2️⃣ **Gray Leaf Spot** - appears as gray lesions. 3️⃣ **Rust** - orange/brown pustules. Preventive measures include crop rotation, resistant varieties, and timely fungicide application.",
//       'tomato disease': "🐛 **Common Tomato Diseases:**\n• **Late Blight** - dark spots on leaves\n• **Early Blight** - target-like spots\n• **Tomato Yellow Leaf Curl** - stunted growth\n• **Blossom End Rot** - dark spots on fruit bottom\n💡 Prevention: Use certified seeds, proper spacing, and organic fungicides.",
//       'pest control': "🌿 **Integrated Pest Management (IPM) Tips:**\n1. Monitor fields regularly\n2. Use biological controls (beneficial insects)\n3. Practice crop rotation\n4. Apply organic pesticides when necessary\n5. Remove infected plants promptly",
//       'organic farming': "🌱 **Organic Farming Practices:**\n• Use compost and manure\n• Practice green manuring\n• Implement crop rotation\n• Use natural pest repellents (neem, garlic)\n• Maintain soil health with cover crops",
//       'fertilizer': "📊 **Fertilizer Recommendations:**\n• **Nitrogen** - for leafy growth\n• **Phosphorus** - for root development\n• **Potassium** - for disease resistance\nApply based on soil test results. Consider organic options like manure, compost, and bio-fertilizers.",
//       'irrigation': "💧 **Smart Irrigation Tips:**\n• Water early morning or late evening\n• Use drip irrigation for efficiency\n• Mulch to retain moisture\n• Install rain gauges\n• Practice deficit irrigation during scarcity",
//       'harvest': "🌾 **Harvesting Best Practices:**\n• Harvest at proper maturity stage\n• Use clean, sharp tools\n• Handle produce gently\n• Harvest during cool hours\n• Sort and grade immediately",
//       'storage': "📦 **Post-Harvest Storage:**\n• Clean and dry storage area\n• Maintain proper temperature\n• Control humidity levels\n• Use hermetic bags for grains\n• Regular pest inspection",
//       'weather': "☀️ **Weather-Based Farming:**\n• Monitor weather forecasts\n• Plant according to rainy seasons\n• Use drought-resistant varieties\n• Install weather stations\n• Practice rainwater harvesting",
//     };
...
//       return "Hello! 👋 I'm your AI farming assistant. Ask me about crop diseases, pest control, organic farming, fertilizers, or any agricultural topic!";
//     }
    
//     if (lowerMessage.includes('thank')) {
//       return "You're welcome! 🌟 Happy farming! Feel free to ask if you need more help.";
//     }
    
//     if (lowerMessage.includes('pest') || lowerMessage.includes('insect')) {
//       return "🐞 **Pest Management Tips:**\n• Use neem oil spray\n• Install pheromone traps\n• Encourage natural predators\n• Practice crop rotation\n• Remove crop residues\nNeed specific pest identification? Describe what you're seeing!";
//     }
...
//   const stats = [
//     { number: '50K+', label: 'Farmers Helped', icon: FiUsers },
//     { number: '500+', label: 'Resources', icon: FiEye },
//     { number: '98%', label: 'Success Rate', icon: FiCheckCircle },
//     { number: '24/7', label: 'AI Support', icon: FiMessageCircle },
//   ];
...
//             className="fixed top-20 left-1/2 transform -translate-x-1/2 z-50 bg-gradient-to-r from-primary to-primary-dark text-white px-6 py-3 rounded-lg shadow-lg flex items-center gap-3"
//           >
//             <FiMessageCircle className="text-yellow-300" size={20} />
//             <span>👋 Welcome to AgriPoa! How can I help you today?</span>
//           </motion.div>
//         )}
//       </AnimatePresence>
...
//                   </div>
//                   <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -mt-2">
//                     <div className="bg-yellow-400 text-primary w-8 h-8 rounded-full flex items-center justify-center font-bold">
//                       {item.step}
//                     </div>
//                   </div>
//                 </div>
...
//               <div className="p-3 border-t border-gray-200 bg-white">
//                 <div className="flex gap-2 overflow-x-auto pb-2">
//                   {['Crop disease', 'Pest control', 'Organic farming', 'Fertilizer tips'].map((q) => (
//                     <button
//                       key={q}
//                       onClick={() => {
//                         setInputMessage(q);
